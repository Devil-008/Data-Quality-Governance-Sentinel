...
def _log_monitoring_event(
    ...
    try:
        ...
        # Note: Vector indexing for monitoring logs disabled due to dependency conflicts
        # Can be re-enabled once chromadb/opentelemetry versions are aligned
    except Exception as e:
                    ...
                    if ds_info and ds_info["connector_type"] == "mysql":
                        ...
                        if issues:
                            severity = (
                                "high"
                                if score < 70
                                else ("medium" if score < 85 else "low")
                            )
                            _create_alert(
                                "quality",
                                severity,
