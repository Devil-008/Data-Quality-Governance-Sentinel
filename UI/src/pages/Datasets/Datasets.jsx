                ...
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    {profile.dataset.quality_score != null || profile.dataset.contains_pii != null ? (
                      <>
                        <strong>Data Quality:</strong> {profile.dataset.quality_score != null ? `The dataset has a quality score of ${profile.dataset.quality_score}%. ` : 'No quality data available. '}
                        <br />
                        <strong>PII:</strong> {profile.dataset.contains_pii ? `PII data was detected (${profile.dataset.pii_categories || 'various categories'}). ` : 'No PII data detected. '}
                        <br /><br />
                        <em>Reasoning:</em> (LLM generated reasoning and summary will appear here based on the column distributions and PII matches...)
                      </>
                    ) : (
